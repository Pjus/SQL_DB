...
INSERT INTO ORGANIZATION(ORG_NAME, ORG_CODE, UP_ORG)
VALUES
('01', '대표이사', NULL),
('02', '생산 부사장', '01'),
('03', '기술 부사장', '01'),
...
ALTER TABLE ORGANIZATION ADD COLUMN UP_ORG REAL NULL;

BEGIN TRANSACTION;

CREATE TABLE OR_TEMP(
ORG_CODE TEXT PRIMARY KEY,
ORG_NAME TEXT NULL,
UP_ORG TEXT NULL
);

INSERT INTO OR_TEMP(ORG_CODE,ORG_NAME,UP_ORG)
SELECT ORG_NAME, ORG_CODE, UP_ORG
FROM ORGANIZATION;
